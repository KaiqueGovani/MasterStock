...
def lerPaginaQrCode(link):
    ...
    for produto in produtos:
        ...
        info_produto ['codigo'] = produto.find_element(By.CSS_SELECTOR, ".RCod").text
        info_produto ['quantidade'] = produto.find_element(By.CSS_SELECTOR, ".Rqtd").text
        info_produto ['valor_unitario'] = produto.find_element(By.CSS_SELECTOR, ".RvlUnit").text
        info_produto ['valor_total'] = produto.find_element(By.CSS_SELECTOR, ".valor").text

        lista_produtos.append(info_produto)

    valor_completo = driver.find_element(By.CSS_SELECTOR, "#totalNota")
    valor_completo_exibido = valor_completo.find_element(By.CSS_SELECTOR, ".txtMax").text
        
    objeto_final = {"produtos":lista_produtos, "valor_completo":valor_completo_exibido}
